"""URL Analyzer service combining feature extraction, ML classification, and rule-based detection."""
...
class URLAnalyzer:
    """Main URL analyzer combining feature extraction, ML, and rule-based detection."""
    ...
    def _load_ml_classifier(self) -> None:
        ...
        try:
            from src.ml.train_fast import URLClassifier
            ...
            if classifier.load():
                ...
                logger.warning("ML classifier not found, using rules only")
                self.use_ml = False
    ...
    def analyze(self, url: str) -> AnalysisResult:
        ...
        Combines ML classification with rule-based detection for robust analysis.
